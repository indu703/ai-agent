...
import { Camera, RefreshCw, ShieldCheck, User, UserX, AlertCircle, ArrowLeft, Globe, Zap, Fingerprint, Activity, ShieldAlert } from 'lucide-react';
...
const Recognition = () => {
    ...
    const captureAndIdentify = useCallback(async () => {
        ...
        const now = Date.now();
        if (recognitionResult?.identity === 'known' &&
        ...
        <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col relative overflow-hidden">
            ...
            <header className="glass-morphism border-b border-white/5 p-6 sticky top-0 z-50">
                <div className="max-w-7xl mx-auto flex justify-between items-center">
                    <div className="flex items-center gap-4">
                        <Link to="/" className="w-10 h-10 bg-white/5 hover:bg-white/10 rounded-xl flex items-center justify-center border border-white/10 transition-colors">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <h1 className="text-xl font-bold tracking-tight bg-gradient-to-r from-white to-slate-400 bg-clip-text text-transparent">Sentinel Vision</h1>
                        </div>
                    </div>
                    ...
                    <div className="hidden md:flex items-center gap-6">
                        <div className="flex items-center gap-2 px-4 py-1.5 bg-green-500/10 rounded-full border border-green-500/20">
                            ...
                            <span className="text-[10px] font-bold uppercase tracking-widest text-green-400">System Active</span>
                        </div>
                        <div className="flex items-center gap-2 text-slate-400">
                            <Globe className="w-4 h-4" />
                            <span className="text-[10px] font-bold uppercase tracking-widest">Node: L-5433</span>
                        </div>
                    </div>
                </div>
            </header>
            ...
            <main className="flex-1 flex flex-col lg:flex-row p-6 lg:p-12 gap-8 items-center justify-center max-w-7xl mx-auto w-full">
                ...
                <div className="relative group w-full lg:flex-1 aspect-video bg-slate-900 rounded-3xl border border-white/10 overflow-hidden shadow-2xl ring-1 ring-white/5">
                    ...
                    {error && (
                        <div className="absolute inset-0 flex flex-col items-center justify-center bg-slate-950/90 z-20 backdrop-blur-md">
                            ...
                            <p className="text-red-400 mb-8 px-6 text-center font-semibold text-lg">{error}</p>
                    ...
                    <div className="absolute bottom-6 left-1/2 -translate-x-1/2 flex items-center gap-6 px-6 py-3 glass-morphism rounded-2xl border-white/10 z-20 min-w-[300px] justify-center">
                        <div className="flex items-center gap-3">
                            <div className={`w-2.5 h-2.5 rounded-full ${isProcessing ? 'bg-amber-400 shadow-[0_0_8px_rgba(251,191,36,0.6)] animate-pulse' : 'bg-green-500 shadow-[0_0_8px_rgba(34,197,94,0.6)]'}`} />
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest leading-none">Biometric Engine v2.0</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="w-full lg:w-96 space-y-6">
                    <div className="glass-card p-10 min-h-[400px] flex flex-col items-center justify-center text-center relative overflow-hidden group border-white/5 transition-all">
                        ...
                        {!recognitionResult ? (
                            <div className="space-y-6 animate-pulse">
                                ...
                                <div>
                                    <h3 className="text-xl font-bold text-slate-500 uppercase tracking-widest">Awaiting Identity</h3>
                                    <p className="text-sm text-slate-600 mt-2 font-medium">Position Subject in Frame</p>
                                </div>
                            </div>
                            ...
                            <div className="space-y-8 w-full animate-fade-in">
                                ...
                                <div className="space-y-2">
                                    <p className="text-xs font-bold text-green-400 uppercase tracking-[0.3em] mb-3">Identity Verified</p>
                                    <h3 className="text-4xl font-bold text-white tracking-tight">{recognitionResult.name}</h3>
                                    <div className="pt-2">
                                ...
                                <div className="grid grid-cols-2 gap-px bg-white/5 rounded-2xl overflow-hidden border border-white/5">
                                    <div className="p-4 bg-slate-900/50 text-left">
                                        <p className="text-[10px] text-slate-500 uppercase font-bold tracking-widest mb-1 font-mono">Decision</p>
                                        <p className="font-bold text-blue-400 text-xs uppercase">{recognitionResult.decision_type || 'Verified'}</p>
                                    </div>
                                    <div className="p-4 bg-slate-900/50 text-left">
                                        <p className="text-[10px] text-slate-500 uppercase font-bold tracking-widest mb-1 font-mono">Match Score</p>
                                        <p className="font-bold text-slate-200">{((1 - recognitionResult.distance) * 100).toFixed(1)}%</p>
                                    </div>
                                </div>
                            ...
                            <div className="space-y-8 animate-fade-in w-full">
                                ...
                                <div className="space-y-3">
                                    <h3 className="text-2xl font-bold text-white tracking-tight">Access Protocol Failure</h3>
                    ...
                    <div className="glass-card p-6 border-white/5 bg-blue-600/5 group hover:bg-blue-600/10 transition-all cursor-default">
                        <div className="flex gap-4">
                            <div className="w-10 h-10 bg-blue-500/20 rounded-xl flex items-center justify-center shrink-0 border border-blue-500/20">
                                <Activity className="w-5 h-5 text-blue-400" />
                            </div>
                            <div className="space-y-1">
                                <p className="text-[10px] font-bold text-blue-400 uppercase tracking-widest leading-none">Real-Time Telemetry</p>
                                <p className="text-xs text-slate-400 font-medium leading-relaxed">
                                    Encryption active. Biometric samples are hashed locally before transmission.
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <footer className="p-8 text-center border-t border-white/5 relative z-10">
                <p className="text-[10px] text-slate-600 font-bold uppercase tracking-[0.4em]">
                    Deepmind Sentinel Biometric System &bull; Version 2.0.8-SR &bull; All Sessions Regulated
                </p>
            </footer>
